...
<div class="content mt-3">
  <div class="animated fadeIn">
            ...
            @endif 
            <div class="card">
                <div class="card-header bg-success text-light"><strong>Edit</strong><small> Partner</small></div>
                    ...
                    <form wire:submit.prevent="updatePartner">
                        ...
                        <div class="form-group">
                            ...
                            @if ($newimage)
                                ...
                                @else
                                 <img  src="{{asset('assets/images/partner')}}/{{$image}}" width="300" height="200" alt="">
                                @endif
