...
<div class="content mt-3">
  <div class="animated fadeIn">
    ...
    @if (Session::has('message'))
     ...
     @endif 
            <div class="card">
                <div class="card-header bg-primary text-light"><strong>Add</strong><small> Service to Sofware Services page </small></div>
                <div class="card-body card-block">
                    <form wire:submit.prevent="addSoftwareService">
                        ...
                        <div class="form-group">
                            ...
                            <input id="s_discount_price" rows="10" cols="10" class="form-control" wire:model="s_discount_price" placeholder="Service Price">
                        ...
                        <div class="form-group">
                            ...
                            <input id="s_price" rows="10" cols="10" class="form-control" wire:model="s_price" placeholder="Service Price">
                        ...
                        <div class="form-group">
                            ...
                            <input type="file" id="s_image" class="form-control" wire:model="s_image">
                            <div wire:loading wire:target="s_image">Uploading...</div>
                            @if ($s_image)
                                <img src="{{ $s_image->temporaryUrl() }}" width="120">
                            @endif
