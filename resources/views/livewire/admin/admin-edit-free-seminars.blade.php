...
<div class="content mt-3">
  <div class="animated fadeIn">
    ...
    @endif 
            <div class="card">
                <div class="card-header bg-success text-light"><strong>Edit</strong><small> Free Seminars</small></div>
                <div class="card-body card-block">
                    <form wire:submit.prevent="updateFreeSeminar">
                        <div class="form-group">
                            <label for="seminar_name" class=" form-control-label">Seminar Name</label>
                            <input type="text" id="seminar_name" class="form-control" wire:model="seminar_name">
